...
@export var boundary_bottom_y: float = 800.0
@export var boundary_left_x: float = 680.0
@export var boundary_right_x: float = 1440.0
...
func _physics_process(_delta: float) -> void:
	...
	# Restrict opponent to certain boundaries
